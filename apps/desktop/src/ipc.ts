...
import type { Project, Session, TimerView } from './types';
...
export const ipc = {
  ...
  timerStart: (projectId: string | null, description: string | null) =>
    invoke<TimerView>('timer_start', { args: { project_id: projectId, description } }),
